                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Daftar Assessee</h3>
...
<?
   ...
   if(!$db){
      ...
      echo "<span class='text-success'><i>*connected*</i></span>";
   }
...
?>
                                        ...
                                        <tr>
                                            <td>
											<a href="profile.php?profile_id=<?=$row['profile_id'];?>&project_activity_id=<?=$row['project_Activity_id'];?>">
											<?=$row['nip'];?>
											</a></td>
